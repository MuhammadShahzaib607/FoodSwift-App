        ...
        <LinearGradient colors={["#fc8c3f", "#f35144"]} style={styles.container}>
            ...
            <View style={styles.bottom}>
                <View style={styles.bottomTextCon}>
                    <Text style={styles.welcomeHeading}>Get Started Free</Text>
                    <Text style={styles.welcomeSubheading}>free Forever No Credit Card Needed</Text>
                </View>

                <View style={styles.inputCon}>
                    <View style={styles.customInput}>
                        <Text style={styles.inputText}>Username</Text>
                        <TextInput style={styles.inputField} autoComplete='off' placeholder='Enter Your Username'></TextInput>
                    </View>
                    <View style={styles.customInput}>
